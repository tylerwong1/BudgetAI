...
class UserLoginTest(unittest.TestCase):
    ...
    def test_signup(self):
        ...
        """
        response = self.app.post('/user/signup', json={
            "name": "Test User",
        ...
        self.assertNotEqual(inserted_user["password"], "password123")  # Check if password is encrypted
    ...
    def test_signup_existing_user(self):
        ...
        """
        self.app.post('/user/signup', json={
            "name": "Test User",
    ...
    def test_login(self):
        ...
        self.assertIn("name", response.get_json())  # Verify user is returned in response
    ...
    def test_login_invalid_credentials(self):
        ...
        self.assertEqual(response.status_code, 401)  # Expecting a 401 Unauthorized status
